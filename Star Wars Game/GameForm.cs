...
{   
    public partial class GameForm : Form
    {
        ...
        SoundPlayer laser = new SoundPlayer(@"D:\GitRepos\MSSA_Projects\MSSA_Projects\Star Wars Game\Resources\blaster-firing.wav");
        SoundPlayer explosion = new SoundPlayer(@"D:\GitRepos\MSSA_Projects\MSSA_Projects\Star Wars Game\Resources\damage.wav");
        SoundPlayer hit = new SoundPlayer(@"D:\GitRepos\MSSA_Projects\MSSA_Projects\Star Wars Game\Resources\LAZER.wav");
        SoundPlayer scream = new SoundPlayer(@"D:\GitRepos\MSSA_Projects\MSSA_Projects\Star Wars Game\Resources\WilhelmScream.wav");
        SoundPlayer cantina = new SoundPlayer(@"D:\GitRepos\MSSA_Projects\MSSA_Projects\Star Wars Game\Resources\star-wars-cantina-song.wav");
        SoundPlayer jabba = new SoundPlayer(@"D:\GitRepos\MSSA_Projects\MSSA_Projects\Star Wars Game\Resources\jabba-the-hutt-laughing.wav");
